...
<body>
    ...
    <h1>Cadastro Company</h1>
    <form action="/company/new" method="post">
        @csrf
        <input type="text" name="name" placeholder="Enter name">
        <input type="text" name="nameFederation" placeholder="Enter name Federation">
        <input type="text" name="Email" placeholder="Enter name E-mail">
        <button type="submit" class="btn btn-success">Register</button>
    </form>
    <form action="/company/find/id" method="post">
    @csrf
        <input type="text" name="filter" placeholder="Filtrar:" class="form-control">
        <button type="submit" class="btn btn-success">List General</button>
    </form>
